const i18n_ru = {
    "translation": {
        ...
        "readme": `<p style="text-align: center;">Описание</p>
            ...
            <p style="text-align: center; color: red;">ВНИМАНИЕ</p>
            <p style="text-align: justify; color: red;">Устройства Apple с версией <strong>iOS 17.4</strong> отключили возможность устанавливать PWA приложения в EU. Это значит что калькулятор будет работать как сайт во вкладке браузера на этих устройствах. Возможное решение - смена местоположения устройства.</p>
