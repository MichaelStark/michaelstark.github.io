const i18n_ru = {
    "translation": {
        ...
        "readme_part_3": `<p style="text-align: center;"><strong>(-) DD force</strong></p>
            ...
            <p>В случае, если до блокировки ввода не было вычислений, то приложение будет форсировать <strong>ЧИСЛО&nbsp;</strong>по одной цифре на каждое касание по экрану в то время когда ввод заблокирован. Это еще одна функциональность.</p>`,
        ...
        "readme": `<p style="text-align: center;">Описание</p>
            ...
            <p style="text-align: center;">Улучшено отображение истории. Теперь последние операции находятся вверху списка. Состояние историии вкл/выкл храниться в памяти. Уведомления будут постоянно появлятся на каждое изменение пользователем. Старые уведомления будут очищаться. Будет отображаться только одно уведомление с актуальной историей. Улучшена инструкция (немного).</p>
